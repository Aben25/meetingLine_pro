...
export default function Person({ name, id, queueList_bool, index, admin, adminUser }) {
    ...
    <div className="border-solid border-2 border-gray-800 radius-2 p-2 rounded-md mb-3 max-w-sm	 ring-offset-2 ring-3">
      <div className="flex flex-row borderd text-center">
        ...
        <div className="basis-2/1 mr-5 muted">
          {adminUser === name ? (
            <p class="text-sky-400/25 text-xs mt-1 border pr-1 pl-1 border-collapse border-r-1 rounded border-gray-600">
              Admin
            </p>
          ) : null}
        </div>
